...
export default async function ResourcePage({ params }: PageProps) {
  ...
  const typeInfo =
    TYPE_LABELS[resource.type] || TYPE_LABELS.belge;

  const statusInfo =
    STATUS_LABELS[resource.status] || STATUS_LABELS.to_read;

  const cleanExternalUrl = resource.external_url
      ...
      <div className="detail-card">
        ...
        >
          <div
            ...
            style={{
              background: typeInfo.color.bg,
              color: typeInfo.color.fg,
              width: 48,
              height: 48,
              fontSize: 22,
              flexShrink: 0,
